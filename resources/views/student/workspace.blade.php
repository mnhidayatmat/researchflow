        ...
        <div class="space-y-6">
            ...
            <x-card title="Quick Actions" :padding="'tight'">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('student.reports.index') }}" class="flex items-center gap-2 px-3 py-2 text-sm text-secondary hover:text-primary hover:bg-surface rounded-lg transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
